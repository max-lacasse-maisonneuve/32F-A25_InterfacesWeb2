...
/**
 * Classe pour une modale de succès, hérite de la classe Modale
 */
class ModaleSucces extends Modale {
     ...
     */
    _injecterHTML() {
        let gabarit = `<div class="modale__conteneur invisible" data-etat="succes">
